...
def generate_noise_I(noise):
    ...
    for i in noise_rate:
        ...
        output_file = h5py.File('./noise/WIKI-noise_{}.h5'.format(i), 'w')
...
if __name__ == "__main__":  
    ...
    #generate_noise_F(noise_rate)#MIRFlickr
    #generate_noise_I(noise_rate) #IAPR
    #generate_noise_M(noise_rate)#MS-COCO
    #generate_noise_N(noise_rate)#NUS-WIDE
    generate_noise_W(noise_rate)#WIKI
